...
#CURRENTLY ONLY RETURNS ONE SCHEDULE
class GeneticAlg:
    ...
    def crossover_population(self, population):
        ...
        for i in range(POPULATION_SIZE):
            ...
            while schedule1 == schedule2:
                schedule2 = np.random.choice(population.get_schedules(), 1, p = probabilities)[0]
            crossover_pop.get_schedules().append(self.mate_schedules(schedule1, schedule2))
        return crossover_pop

    def mate_schedules(self, sched1, sched2):
        crossover_sched = Schedule().create()
